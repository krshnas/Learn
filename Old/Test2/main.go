...
// 		ExposedPorts: []string{"5433/tcp"}, // Use 5433 instead of 5432
...
func ValidateDbConnection(host, user, password string, port int, useSSL bool) (bool, error) {
	if host == "" || user == "" || password == "" || port == 0 {
		return false, errors.New("missing database details")
	}
